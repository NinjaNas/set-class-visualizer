...
const localAudioProgram = localStorage.getItem('graphAudioProgram')
const graphAudioProgram = ref<string>(localAudioProgram ? localAudioProgram : '0')

const $emit = defineEmits(['changeGraphAudioProgram'])

watch(graphAudioProgram, () => {
  $emit('changeGraphAudioProgram', graphAudioProgram.value)
  localStorage.setItem('graphAudioProgram', graphAudioProgram.value)
})
</script>

<template>
  <label for="graphAudioProgram">Graph Audio Patch:</label>
  <select id="graphAudioProgram" name="graphAudioProgram" v-model="graphAudioProgram">
    ...
    <option disabled>Chromatic Percussion</option>
    ...
    <option disabled>Synth Lead</option>
    ...
    <option disabled>Synth Pad</option>
    ...
    <option disabled>Synth Effects</option>
    ...
    <option disabled>Percussive</option>
    ...
    <option disabled>Sound Effects</option>
